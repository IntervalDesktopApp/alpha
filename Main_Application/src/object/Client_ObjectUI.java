...
public class Client_ObjectUI {
    ...
    private void rename() throws IOException {
        ...
        if(!duplicateClient(newName)) {
            ...
            Alert_Windows.confirmDialog("Duplikat entdeckt", "Kunde bereits vorhande", "Bitte einen einzigartigen Namen vergeben");
        }
    }
    ...
    private void delete() throws IOException {
        System.out.println(name + ": " + index + " gelöscht");
        Manager.clients.remove(index);
        ctr_client.uiClients.remove(index);
